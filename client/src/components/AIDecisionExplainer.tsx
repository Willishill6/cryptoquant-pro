...
const decisions: Decision[] = [
  {
    id: 1, coin: "BTC", action: "买入", confidence: 92.4, timestamp: "2分钟前", model: "PatchTST-v2.1", price: 54230.50,
    features: [
      { name: "RSI超卖信号", value: 28.5, impact: "positive", weight: 0.23 },
      { name: "链上大户增持", value: 15200, impact: "positive", weight: 0.19 },
      { name: "资金费率转负", value: -0.012, impact: "positive", weight: 0.16 },
      { name: "社交情绪指数", value: 72.3, impact: "positive", weight: 0.14 },
      { name: "波动率收缩", value: 0.42, impact: "positive", weight: 0.12 },
      { name: "宏观利率预期", value: -0.25, impact: "negative", weight: -0.08 },
      { name: "交易所流入量", value: 3200, impact: "negative", weight: -0.05 },
    ],
    reasoning: [
      "RSI(14)=28.5 处于超卖区间，历史回测显示此水平后24h反弹概率78%",
      "链上数据显示鲸鱼地址过去6h净增持15,200 BTC，为近30天最大单日增持",
      "永续合约资金费率-0.012%，空头拥挤度达到历史90%分位",
      "综合7个社交平台NLP分析，恐惧贪婪指数从极度恐惧转向中性",
      "布林带宽度收缩至0.42，预示即将出现方向性突破",
    ],
    outcome: { pnl: 2340, accuracy: true },
  },
  {
    id: 2, coin: "ETH", action: "加仓", confidence: 87.6, timestamp: "8分钟前", model: "TFT-v3.2", price: 3842.30,
    features: [
      { name: "ETH/BTC比率突破", value: 0.068, impact: "positive", weight: 0.21 },
      { name: "DeFi TVL增长", value: 8.5, impact: "positive", weight: 0.18 },
      { name: "Gas费用下降", value: -32, impact: "positive", weight: 0.15 },
      { name: "机构资金流入", value: 450, impact: "positive", weight: 0.13 },
      { name: "技术形态看涨", value: 0.85, impact: "positive", weight: 0.11 },
      { name: "监管风险", value: 0.3, impact: "negative", weight: -0.06 },
    ],
    reasoning: [
      "ETH/BTC汇率突破0.068关键阻力位，MACD金叉确认",
      "DeFi协议TVL过去7天增长8.5%，资金回流以太坊生态",
      "Layer2采用率提升导致主网Gas费下降32%，用户体验改善",
      "灰度ETHE基金过去5天净流入$4.5亿，机构持续配置",
    ],
    outcome: { pnl: 1560, accuracy: true },
  },
  {
    id: 3, coin: "SOL", action: "减仓", confidence: 78.3, timestamp: "15分钟前", model: "GNN-Market-v1.5", price: 187.45,
    features: [
      { name: "网络拥堵加剧", value: 85, impact: "negative", weight: 0.22 },
      { name: "大户转出增加", value: 8500, impact: "negative", weight: 0.18 },
      { name: "技术形态看跌", value: 0.72, impact: "negative", weight: 0.15 },
      { name: "生态TVL下降", value: -5.2, impact: "negative", weight: 0.12 },
      { name: "短期超买", value: 76.8, impact: "negative", weight: 0.10 },
      { name: "长期趋势向上", value: 0.65, impact: "positive", weight: -0.08 },
    ],
    reasoning: [
      "Solana网络TPS利用率达85%，近期多次出现区块延迟",
      "前100大户地址过去12h净转出8,500 SOL至交易所",
      "4H级别形成头肩顶形态，颈线位$148.5面临考验",
      "Solana DeFi TVL过去7天下降5.2%，部分资金迁移至Base",
    ],
    outcome: { pnl: -890, accuracy: false },
  },
  {
    id: 4, coin: "AVAX", action: "买入", confidence: 83.1, timestamp: "22分钟前", model: "PatchTST-v2.1", price: 42.80,
    features: [
      { name: "子网活跃度激增", value: 45, impact: "positive", weight: 0.20 },
      { name: "机构合作消息", value: 1, impact: "positive", weight: 0.17 },
      { name: "技术突破确认", value: 0.88, impact: "positive", weight: 0.15 },
      { name: "链上活跃地址", value: 12.3, impact: "positive", weight: 0.13 },
      { name: "市场情绪中性", value: 52, impact: "positive", weight: 0.08 },
    ],
    reasoning: [
      "Avalanche子网过去30天新增45个，游戏和RWA赛道增长显著",
      "检测到与传统金融机构合作的链上证据（智能合约部署）",
      "日线级别突破下降趋势线，成交量放大2.3倍确认突破有效",
    ],
  },
  {
    id: 5, coin: "DOGE", action: "卖出", confidence: 71.5, timestamp: "35分钟前", model: "Sentiment-NLP-v2.1", price: 0.182,
    features: [
      { name: "社交热度衰减", value: -42, impact: "negative", weight: 0.25 },
      { name: "鲸鱼抛售信号", value: 2800, impact: "negative", weight: 0.20 },
      { name: "技术指标超买", value: 82.1, impact: "negative", weight: 0.15 },
      { name: "Meme板块轮动", value: 0.7, impact: "negative", weight: 0.10 },
    ],
    reasoning: [
      "Twitter/X上DOGE相关讨论量过去48h下降42%，热度消退",
      "前50大DOGE持仓地址过去24h净卖出2,800万DOGE",
      "RSI(14)=82.1，严重超买，历史数据显示此水平后72h回调概率65%",
    ],
  },
];
